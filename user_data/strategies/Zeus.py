...
# IMPORTANT: INSTALL TA BEFOUR RUN(CCCCCCZS)
...
class Zeus(IStrategy):
    ...
    # buy_params = {'buy_cat': '<R', 'buy_real': 0.0128}
    # # Sell hyperspace params:
    # sell_params = {'sell_cat': '=R', 'sell_real': 0.9455}
    # # ROI table:
    ...
    buy_params = {'buy_cat': '<R', 'buy_real': 0.1445}
    # Sell hyperspace params:
    sell_params = {'sell_cat': '=R', 'sell_real': 0.8242}
    # ROI table:
    minimal_roi = {'0': 0.704, '1055': 0.115, '1800': 0.033, '5082': 0}
    leverage_optimize = False                                                                                                                                                                                                                                                                                                                                                                                                                       
    leverage_num = IntParameter(low=5, high=20, default=15, space='buy', optimize=leverage_optimize)
